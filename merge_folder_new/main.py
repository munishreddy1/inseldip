...
node_list_main_steps = ['ns=3;s="Lab_Parameter"."TestName"', 'ns=3;s="Datatostring"."MainStep_Concat"[0]', 'ns=3;s="Datatostring"."MainStep_Concat"[1]', 'ns=3;s="Datatostring"."MainStep_Concat"[2]', 
                        ...
                        'ns=3;s="Datatostring"."MainStep_Concat"[30]', 'ns=3;s="Datatostring"."MainStep_Concat"[31]']
...
#Writing values into sub_steps table    
    ...
    # Insert values into the post_process PostgreSQL database
    cur = conn.cursor()
    cur.execute('''INSERT INTO post_process(testid2, particle_sizes, particle_size_distribution, yield,recovery,
